            ...
            <div class="mt-6 pt-6 border-t border-gray-200">
                <div class="bg-indigo-50 border border-indigo-200 rounded-lg p-4">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-indigo-800">Torre Integration</h3>
                            <div class="mt-2 text-sm text-indigo-700">
                                <p>Enter your <strong>Torre username</strong> to authenticate.</p>
                                <p class="mt-1">Your profile data will be cached for 24 hours.</p>
                                <p class="mt-2"><strong>Example usernames:</strong></p>
                                <ul class="mt-1 list-disc list-inside text-xs">
                                    <li>torrenegra (Founder)</li>
                                    <li>renanpeixotox (Head of Engineering)</li>
                                    <li>Try your own Torre username!</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-2">
                            <p class="text-xs text-green-700 font-medium">
                                Fast Loading: Profile data cached with Redis for 24h
                            </p>
                        </div>
                    </div>
                </div>
